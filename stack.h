...
#define DEFINE_LST_STACK(type)                                                                                                                            \
    ...
    {                                                                                                                                                     \
        ...
        int state; /* 0 == not ok else ok*/                                                                                                               \
                                                                                                                                                          ...
                                                                                                                                                          \
    type##_LstStack *type##CreateStack(void (*destroyFunc)(void *), int (*compareFunc)(type, type), void (*printFunc)(type##_LstStack *), type nullValue) \
    {                                                                                                                                                     \
...
#define DEFINE_ARR_STACK(type, size)                                                                                                                      \
    ...
    int type##IsEmpty(type##_ArrStack *stack);                                                                                                            \
                                                                                                                                                          \
    type##_ArrStack *type##CreateStack(void (*destroyFunc)(void *), int (*compareFunc)(type, type), void (*printFunc)(type##_ArrStack *), type nullValue) \
    {                                                                                                                                                     \
