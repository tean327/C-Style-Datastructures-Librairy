...
#define DEFINE_LIST(type)                                                                                                                                            \
    ...
    {                                                                                                                                                                \
        ...
        void (*print)(struct type##_list_node *);                                                                                                                    \
        type (*copy)(type);                                                                                                                                          \
        struct type##_list_node *next;                                                                                                                               \
    } type##_ListNode;                                                                                                                                               \
                                                                                                                                                                     \
    type##_ListNode *type##CreateList(void (*destroyFunc)(void *), int (*compareFunc)(type, type), void (*printFunc)(struct type##_list_node *), type (*copy)(type)) \
    {                                                                                                                                                                \
    ...
    {                                                                                                                                                                \
        ...
        if (newNode->copy)                                                                                                                                           \
            newNode->VALUE = newNode->copy(value);                                                                                                                   \
        else                                                                                                                                                         \
            newNode->VALUE = value;                                                                                                                                  \
        newNode->next = NULL;                                                                                                                                        \
        if (head->next == NULL)                                                                                                                                      \
